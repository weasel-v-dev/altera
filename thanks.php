...
<!-- End Google Tag Manager -->
    ...
    <!-- Global site tag (gtag.js) - Google Ads: 760130300 -->
    <script async src="https://www.googletagmanager.com/gtag/js?id=AW-760130300"></script>
...
<script>
	setTimeout(function() {
		window.location.href = 'http://altera-med.com/';
	}, 2200);
</script>
<?php
	require 'footer.php';
